...
class RedirectView(MessageMixin, generic.RedirectView):
    """
    Extending django's generic view to add MessageMixin's functionality
    """


class FormView(FormMessageMixin, generic.FormView):
    """
    Extending django's generic view to add DeleteMessageMixin's functionality
    """


class TemplateView(MessageMixin, generic.TemplateView):
    """
    Extending django's template view to add MessageMixin's functionality
    """
